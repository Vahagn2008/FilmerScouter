...
public class PlaceEntity {
    ...
    public PlaceEntity(PlaceRequest request) {
        ...
        this.distanceFromHotel = (request.getDistanceFromHotel() != null)
                ? request.getDistanceFromHotel() : null;
        this.nearbyHospitalsId = request.getNearbyHospitals() != null ? request.getNearbyHospitals().getId() : null;
        this.distanceFromHospital = (request.getDistanceFromHospital() != null)
                ? request.getDistanceFromHospital() : null;
        this.nearbyPharmaciesId = request.getNearbyPharmacies() != null ? request.getNearbyPharmacies().getId() : null;
        this.distanceFromPharmacy = (request.getDistanceFromPharmacy() != null)
                ? request.getDistanceFromPharmacy() : null;
        this.gasStationsId = request.getGasStations() != null ? request.getGasStations().getId() : null;
        this.distanceFromGasStation = (request.getDistanceFromGasStation() != null)
                ? request.getDistanceFromGasStation() : null;
        this.foodPlacesId = request.getFoodPlaces() != null ? request.getFoodPlaces().getId() : null;
        this.distanceFromFoodPlace = (request.getDistanceFromFoodPlace() != null)
                ? request.getDistanceFromFoodPlace() : null;
...
//        this.photo360Id = request.getPhoto360() != null ? request.getPhoto360().getId() : null;
//        this.roadQualityId = request.getRoadQuality() != null ? request.getRoadQuality().getId() : null;
//        this.nearbyHotelsId = request.getNearbyHotels() != null && !request.getNearbyHotels().isEmpty()
//                ? request.getNearbyHotels().get(0).getId() : null;
//        this.nearbyHospitalsId = request.getNearbyHospitals() != null && !request.getNearbyHospitals().isEmpty()
//                ? request.getNearbyHospitals().get(0).getId() : null;
//        this.nearbyPharmaciesId = request.getNearbyPharmacies() != null && !request.getNearbyPharmacies().isEmpty()
//                ? request.getNearbyPharmacies().get(0).getId() : null;
//        this.gasStationsId = request.getGasStations() != null && !request.getGasStations().isEmpty()
//                ? request.getGasStations().get(0).getId() : null;
//        this.foodPlacesId = request.getFoodPlaces() != null && !request.getFoodPlaces().isEmpty()
//                ? request.getFoodPlaces().get(0).getId() : null;
//        this.photosId = request.getPhotos() != null && !request.getPhotos().isEmpty()
//                ? request.getPhotos().get(0).getId() : null;
//        this.transportTypeId = request.getTransportType() != null && !request.getTransportType().isEmpty()
//                ? request.getTransportType().get(0).getId() : null;
//        this.keywordId = (request.getKeywords() != null && !request.getKeywords().isEmpty())
//                ? UUID.fromString(request.getKeywords().get(0)) : null;
//        this.distanceFromHotel = (request.getDistanceFromHotel() != null)
//                ? request.getDistanceFromHotel() : null;
//        this.distanceFromHospital = (request.getDistanceFromHospital() != null)
//                ? request.getDistanceFromHospital() : null;
   ...
   public PlaceRequest toPlaceRequest(Optional<PlaceType> placeType,
       ...
       return PlaceRequest.builder()
               ...
               .transportType(transportTypes
                       .orElse(List.of())
                       .stream()
                       .map(transportType -> TransportType.builder()
